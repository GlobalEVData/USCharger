...
# 文件路径定义
PARDIR = os.path.join(DIR, '..', 'tmp', 'US county-level charger count 2014-2024')

# 原始GeoJSON文件路径
PATH = os.path.join(PARDIR, 'data_usa_evse_count_2014-2024.geojson')
PATH2 = os.path.join(PARDIR, 'data_usa_dc_evse_count_2014-2024.geojson')
PATH3 = os.path.join(PARDIR, 'data_usa_l1_evse_count_2014-2024.geojson')
PATH4 = os.path.join(PARDIR, 'data_usa_l2_evse_count_2014-2024.geojson')

# 输出文件路径
SAVE_PATH = os.path.join(PARDIR, 'data_usa_evse_count_2014-2024_2.json')
SAVE_PATH2 = os.path.join(PARDIR, 'data_usa_dc_evse_count_2014-2024.csv')
SAVE_PATH3 = os.path.join(PARDIR, 'data_usa_l1_evse_count_2014-2024.csv')
SAVE_PATH4 = os.path.join(PARDIR, 'data_usa_l2_evse_count_2014-2024.csv')

# 处理后文件路径
PROCESSED_PATH2 = os.path.join(PARDIR, 'processed_data_usa_dc_evse_count_2014-2024.csv')
PROCESSED_PATH3 = os.path.join(PARDIR, 'processed_data_usa_l1_evse_count_2014-2024.csv')
PROCESSED_PATH4 = os.path.join(PARDIR, 'processed_data_usa_l2_evse_count_2014-2024.csv')
...
def process_data(gdf):
    ...
    simplified_gdf.to_file(PATH, driver='GeoJSON')
...
if __name__ == "__main__":
    ...
    FINAL_OUTPUT_PATH = os.path.join(PARDIR, 'final_merged_evse_data_2014-2024.geojson')
